...
desc 'Generate documentation for the gift_options extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'GiftOptionsExtension'
...
desc 'Test the gift_options extension.'
...
namespace :test do
  desc 'Functional test the gift_options extension.'
  ...
  desc 'Unit test the gift_options extension.'
